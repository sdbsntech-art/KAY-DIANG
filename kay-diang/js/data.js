...
LESSONS: [
  ...
  },
  {
    ...
    content:{
      ...
      words:[
        {ar:"ز", tr:"Zay", fr:"Son 'Z' (Zèbre)", forms:{iso:"ز", ini:"ز", med:"ـز", fin:"ـز"}},
        {ar:"س", tr:"Sin", fr:"Son 'S' (Soleil)", forms:{iso:"س", ini:"سـ", med:"ـسـ", fin:"ـس"}},
        {ar:"ش", tr:"Shin", fr:"Son 'CH' (Chat)", forms:{iso:"ش", ini:"شـ", med:"ـشـ", fin:"ـش"}},
        {ar:"ص", tr:"Sad", fr:"Son 'S' Lourd (Emphatique)", forms:{iso:"ص", ini:"صـ", med:"ـصـ", fin:"ـص"}},
        {ar:"ض", tr:"Dad", fr:"Son 'D' Lourd", forms:{iso:"ض", ini:"ضـ", med:"ـضـ", fin:"ـض"}},
        {ar:"ط", tr:"Ta", fr:"Son 'T' Lourd", forms:{iso:"ط", ini:"طـ", med:"ـطـ", fin:"ـط"}},
        {ar:"ظ", tr:"Dha", fr:"Son 'DH' Lourd", forms:{iso:"ظ", ini:"ظـ", med:"ـظـ", fin:"ـظ"}},
        {ar:"ع", tr:"'Ain", fr:"Son guttural (Gorge)", forms:{iso:"ع", ini:"عـ", med:"ـعـ", fin:"ـع"}},
        {ar:"غ", tr:"Ghain", fr:"Son 'GH' (Gargarisme)", forms:{iso:"غ", ini:"غـ", med:"ـغـ", fin:"ـغ"}},
        {ar:"ف", tr:"Fa", fr:"Son 'F' (Fleur)", forms:{iso:"ف", ini:"فـ", med:"ـفـ", fin:"ـف"}},
        {ar:"ق", tr:"Qaf", fr:"Son 'Q' (Gorge profonde)", forms:{iso:"ق", ini:"قـ", med:"ـقـ", fin:"ـق"}},
        {ar:"ك", tr:"Kaf", fr:"Son 'K' (Café)", forms:{iso:"ك", ini:"كـ", med:"ـكـ", fin:"ـك"}},
        {ar:"ل", tr:"Lam", fr:"Son 'L' (Lune)", forms:{iso:"ل", ini:"لـ", med:"ـلـ", fin:"ـل"}},
        {ar:"م", tr:"Mim", fr:"Son 'M' (Maman)", forms:{iso:"م", ini:"مـ", med:"ـمـ", fin:"ـم"}},
        {ar:"ن", tr:"Nun", fr:"Son 'N' (Nous)", forms:{iso:"ن", ini:"نـ", med:"ـنـ", fin:"ـن"}},
        {ar:"هـ", tr:"Ha", fr:"Son 'H' Doux (Haras)", forms:{iso:"ه", ini:"هـ", med:"ـهـ", fin:"ـه"}},
        {ar:"و", tr:"Waw", fr:"Son 'W' (Oui)", forms:{iso:"و", ini:"و", med:"ـو", fin:"ـو"}},
        {ar:"ي", tr:"Ya", fr:"Son 'Y' (Yaourt)", forms:{iso:"ي", ini:"يـ", med:"ـيـ", fin:"ـي"}},
      ],
      examples:[
  ...
  },
  {
    ...
    title:"Lecture & Construction de Phrases",
    arabic:"القِرَاءَة وَالجُمَل",
    desc:"Concrétisez vos acquis : combinez les lettres pour lire vos premiers mots et phrases complètes.",
    xp:30, duration:"20 min",
    content:{
      intro:"Maintenant que vous connaissez tout l'alphabet, il est temps de combiner ! En arabe, la forme des lettres change pour se 'donner la main'. Voici beaucoup d'exemples concrets.",
      reading: [
        { word: "أَنَا", parts: ["أَ", "نَ", "ا"], fr: "Moi / Je (A-na)" },
        { word: "أَنْتَ", parts: ["أَ", "نْ", "تَ"], fr: "Toi (masculin) (An-ta)" },
        { word: "هُوَ", parts: ["هُ", "وَ"], fr: "Lui / Il (Hu-wa)" },
        { word: "هِيَ", parts: ["هِ", "يَ"], fr: "Elle (Hi-ya)" },
        { word: "بَيْتٌ", parts: ["بَ", "يْ", "تٌ"], fr: "Une maison (Bay-tun)" },
        { word: "بِنْتٌ", parts: ["بِ", "نْ", "تٌ"], fr: "Une fille (Bin-tun)" },
        { word: "وَلَدٌ", parts: ["وَ", "لَ", "دٌ"], fr: "Un garçon (Wa-la-dun)" },
        { word: "كِتَابٌ", parts: ["كِ", "تَ", "ا", "بٌ"], fr: "Un livre (Ki-taa-bun)" },
        { word: "قَلَمٌ", parts: ["قَ", "لَ", "مٌ"], fr: "Un stylo (Qa-la-mun)" },
        { word: "كَلْبٌ", parts: ["كَ", "لْ", "بٌ"], fr: "Un chien (Kal-bun)" },
        { word: "جَمَلٌ", parts: ["جَ", "مَ", "لٌ"], fr: "Un chameau (Ja-ma-lun)" },
        { word: "شَمْسٌ", parts: ["شَ", "مْ", "سٌ"], fr: "Soleil (Sham-sun)" },
        { word: "قَمَرٌ", parts: ["قَ", "مَ", "رٌ"], fr: "Lune (Qa-ma-run)" },
      ],
      examples:[
        {ar:"أَنَا وَلَدٌ", fr:"Ana waladun — Je suis un garçon"},
        {ar:"أَنْتِ بِنْتٌ", fr:"Anti bintun — Tu es une fille"},
        {ar:"هُوَ فِي بَيْتٍ", fr:"Huwa fi baytin — Il est dans une maison"},
        {ar:"هَذَا كِتَابٌ", fr:"Hadha kitabun — Ceci est un livre"},
        {ar:"القَلَمُ عَلَى الكِتَابِ", fr:"Al-qalamu 'ala al-kitabi — Le stylo est sur le livre"},
      ],
      note:"Remarquez comment les lettres se lient : Le Ba (ب) change de forme au début de 'Bayt' (بَيْت). Le Lam (ل) s'attache des deux côtés dans 'Qalam' (قَلَم)."
    }
  },
  {
